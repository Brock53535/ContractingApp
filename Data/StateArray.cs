...
public class StateArray : ValidationAttribute
{

    private readonly List<US_State> states;
    ...
    public override bool IsValid(object value)
    {
        ...
        return states.Any(s => s.Abbreviation.Equals(state, System.StringComparison.CurrentCultureIgnoreCase));
    }
